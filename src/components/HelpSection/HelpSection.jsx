...
const HelpSection = () => {
  ...
  return (
    <div className={styles.helpContainer}>
      <ul>
        <li>
          ...
          <p className={styles.textStyles}>
            Click "Select Color" to open the color palette. Adjust the RGB
        ...
        <li style={{ marginTop: '12px' }}>
          ...
          <p className={styles.textStyles}>
            ...
            <br />
            The color box will become the background color. The selected color
      ...
      <button className={styles.playButton} onClick={playButtonHandle}>&#8592; Continue to Play</button>
      </div>
    </div>
  );
};
